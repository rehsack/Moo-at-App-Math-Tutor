...
\begin{description}
\uncover<2->{\item[Graham ''haarg'' Knop] Found a lot of spelling errors and first suggestions}
\uncover<3->{\item[Vincent ''celogeek'' Bachelier] Suggested some real examples}
\uncover<4->{\item[Fedor Babkin] UML diagram improvements}
\uncover<5->{\item[Curtis ''Ovid'' Poe] Final review and figured out missing fundamentals}
\end{description}
\end{block}
\end{frame}
